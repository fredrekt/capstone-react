...
class Medicines extends Component{
   ...
   async componentDidMount(){
        const allmeds = await fetch('/medicines').then(response => response.json());
...
/*
    ...
    */
    ...
    render(){
        const medicine = this.state.allmeds;
           ...
           <MDBCarousel
                ...
                <MDBCarouselItem itemId="2">
                    ...
                    <MDBMask overlay="black-strong" className="flex-center flex-column text-white text-center">
                        ...
                        <h4>Organic medicines and remedies for the human body.</h4>
                ...
                <Slide up>
                    <h1 className="med-otc-h">{this.state.selmeds}Over the Counter</h1>
                    <MDBContainer>
                    {/* STARTS HERE ANG DISPLAY SA MEDS FROM DB */}
                        <MDBRow>
                            {medicine.map(allmeds => 
                            <MDBCol style={{'margin-bottom':'5%'}} md="6" lg="3">
                                ...
                                <Link to={{
                                    pathname: `/meds/${allmeds.medicine_name}`,
                                }}
                                    color="eleg" 
                                    key={allmeds.med_id} 
